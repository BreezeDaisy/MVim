...
# Constructed_Emotion_Dataset 数据集的置信度取0.6。从93955个样本中伪标注出40259个样本
# Small_sample 数据集的置信度取0.85.
CONF_THRESHOLD = 0.85
...
"""
python Face_Pose/emotion_annotation.py --fairface_root data/FairFace/fairface_0.25_parquet --output Face_Pose/Emotion_dataset

"""

"""
python Face_Pose/emotion_annotation.py --fairface_root data/FairFace/fairface_0.25_parquet --output Face_Pose/Small_sample_0.85
